...
* [Submit a post for your issue](https://github.com/Fab-Doe/repo/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/Fab-Doe/repo/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/Fab-Doe/repo/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/Fab-Doe/repo/compare/).
...
* Engage in discussion on [your issue](https://github.com/Fab-Doe/repo/issues/).
